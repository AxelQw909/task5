@if(session('success'))
    <div class="flex p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
        ...
        <div>
            <span class="font-medium">Успешно!</span> {{ session('success') }}
        </div>
    </div>
@endif
...
@if(session('warning'))
    <div class="flex p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
        ...
        <div>
            <span class="font-medium">Внимание!</span> {{ session('warning') }}
        </div>
    </div>
@endif
...
@if(session('info'))
    <div class="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
        ...
        <div>
            <span class="font-medium">Информация!</span> {{ session('info') }}
        </div>
    </div>
@endif
...
@if ($errors->any())
    <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
        ...
        <span class="sr-only">Ошибки валидации</span>
        <div>
            <span class="font-medium">Обнаружены ошибки:</span>
